<?php include ROOT.'/Views/header.php'; ?>
    ...
    <div class="new-product w100">
        <div class="new-product-top clearfix">
        ...
        <div class="sap_tabs">
            <div id="horizontalTab" style="display: block; width: 100%; margin: 0px;">
                <ul class="resp-tabs-list">
                    <li class="resp-tab-item" aria-controls="tab_item-0" role="tab"><span>About Company</span></li>
        ...
        <div class="new-topday">
            <h3 class="new-models">Our Customers</h3>
            <a href="single.php">
                <div class="today-new-left">
                    <img src="/assets/images/bb1.jpg" class="img-responsive">
                </div>
            </a>
            <a href="single.php">
                <div class="today-new-left">
                    <img src="/assets/images/bb2.jpg" class="img-responsive">
                </div>
            </a>
            <a href="single.php">
                <div class="today-new-left">
                    <img src="/assets/images/bb3.png" class="img-responsive">
                </div>
            </a>
