...
--
-- Host: 127.0.0.1
-- Czas generowania: 15 Maj 2017, 21:04
...
(1, 3, 'model1', 'fcsdh', 1, '225.00', '1', 'assets/img/products/stancesc5blk.jpg', 0, 18),
(2, 4, 'fhjsd', 'Lorem mvklxmkbdf sgdshdhhsdhsdhshsdh', 53, '600.00', '1', 'assets/img/products/enkei-draco-anth_lg_super.jpg', 0, 18),
(3, 4, 'raijin', 'Lorem ipsum dolor sit amet, consectetur adipisicing elit. Nostrum ducimus et laborum, magnam? Aliquam quo ad delectus, quos ex corporis suscipit tempore minima error, provident magnam id hic odit. Iure!', 30, '210.00', '1', 'assets/img/products/enkeitun_raijin_b_pdpfull.jpg', 0, 19),
(4, 3, 'vos1', 'Lorem mvklxmkbdf sgdshdhhsdhsdhshsdh', 520, '400.00', '1', 'assets/img/products/vossen1.png', 0, 20),
(5, 1, 'CS5', 'BBS good wheels kdfnglkdfbknfdn n jngdf kjnfd ndf fdnkj n', 53, '320.00', '1', 'assets/img/products/bbs_cs5_bs_pdpfull.jpg', 0, 20),
(7, 2, 'ALLEGGERITA HLT', 'Lorem mvklxmkbdf sgdshdhhsdhsdhshsdh', 352, '235.00', '1', 'assets/img/products/oz_allerghlt_orng_pdpfull.jpg', 0, 18),
(8, 6, 'MR131', 'Lorem ipsum dolor sit amet, consectetur adipisicing elit. Nostrum ducimus et laborum, magnam? Aliquam quo ad delectus, quos ex corporis suscipit tempore minima error, provident magnam id hic odit. Iure!', 25, '342.00', '1', 'assets/img/products/motegi_mr131tracklite_b_pdpfull.jpg', 0, 18),
(9, 4, 'bfnfgj', '23', 12, '4321.00', '1', 'assets/img/products/enkeitun_raijin_b_pdpfull.jpg', 0, 17);
...
--
ALTER TABLE `products`
  MODIFY `productCode` int(15) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
--
